...
```verilog
`timescale 1ns / 1ps
module Moore_seq(clk,reset,in,out);
input clk,reset,in;
output reg out;
parameter  S0 = 3'b000,
           S1 = 3'b001,
...
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/f4e8b12b-45dc-4235-929d-9f3ce669fd7e" />
